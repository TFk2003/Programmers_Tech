...
public class DepositPage extends javax.swing.JFrame {
    ...
    public void deposit() {
        ...
        try{
            ...
            pst.setInt(2, amount);
            pst.setInt(3, 0);
            pst.setString(4, "Money Deposit through Slip Number " + id);
    ...
    private void initComponents() {
        ...
        txt_id.setPlaceholder("Enter Slip Id...");
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 70, 240, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI Semibold", 1, 30)); // NOI18N
        jLabel3.setText("Slip ID:");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 200, -1, -1));

        rSMaterialButtonCircle1.setText("Deposit");
